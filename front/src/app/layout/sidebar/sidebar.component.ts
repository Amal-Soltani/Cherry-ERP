...
export class SidebarComponent implements OnInit, OnDestroy {
    ...
    constructor(private modalService: NgbModal, public menu: MenuService, public settings: SettingsService, public injector: Injector) {
    ...
    showFeedbackList() {
        this.router.navigate(['/feedbacks/pending']);
    }
}
